...
import backgroundImgRight from '../../../../assets/images/bg/home-section-3-right.png'
				...
				<div className='cw-section-three-text-container'>
					...
					<ScrollAnimation animateIn='animate__fadeInUp' delay={300} animateOnce={true}>
						<h4 className='cw-section-three-subtitle'>
							Whether you are a recent college graduate, midway through your career or a
							retiree your financial goals are unique to you. Professional Exchange carefully
							selects and qualifies a financial professional to work with you and create a
							plan that fits your life stage, preferences, goals, and values.
						</h4>
					</ScrollAnimation>
					<ScrollAnimation animateIn='animate__fadeInUp' delay={500} animateOnce={true}>
						<h4 className='cw-section-three-subtitle'>
							Establishing the right relationship is a key factor in realizing your dreams
					...
					<ScrollAnimation animateIn='animate__fadeInUp' delay={700} animateOnce={true}>
						<div className='cw-section-three-button-container'>
							<Link to={'/wizard/step-one'} className='cw-section-three-button'>
