...
import logoLeave from '../../../../assets/images/icons/leaves.png'
			...
			<div className='cw-section-one-main-container'>
				<ScrollAnimation
					...
					<h4 className='cw-section-one-icon'>
						<Image
							classImg={'cw-section-One-main-logo-img'}
							image={logoLeave}
							alt={'Main Logo'}
							title={'Main Logo'}
						/>
					...
					<h3 className='cw-section-one-title'>
						...
						Connecting you to the right professional is how we build your
