...
export default function StepEight() {
	...
	return (
		<>
			<MetaDescription title={'Specialty-6 | PE.com'} name={'description'} content={'Specialty-6 | PE.com...'} />
						...
						<ScrollAnimation style={{ height: '100%' }} animateIn='animate__slideInRight' delay={300} duration={2} animateOnce={true}>
							<div className='cw-wizard-stseight-form-global-container'>
								<div className='cw-wizard-stseight-form-main-title-container'>
									<MainTitle
										indicators={[{ indicator: true }, { indicator: true }, { indicator: true }, { indicator: true }, { indicator: true }, { indicator: true }]}
								...
								<div className='cw-wizard-stseight-form-container'>
									<ScrollAnimation animateIn='animate__fadeInUp' delay={3000} animateOnce={true}>
										<div className='cw-wizard-stseight-form-title-container'>
											<h2 className='cw-wizard-stseight-form-title'>Is there anything else you would like to know about a client?</h2>
										</div>
										<div className='cw-wizard-stseight-form-option-container'>
											<TextArea rows={6} placeholder={'Add answer here'} onChange={handleChangeTextArea} value={isTextarea} />
										</div>
									</ScrollAnimation>
								</div>
								...
								<div className='cw-wizard-stseight-value-container'>
									<ScrollAnimation animateIn='animate__fadeInUp' delay={3500} animateOnce={true}>
										<div className='cw-wizard-stseight-value-title-container'>
											<h2 className='cw-wizard-stseight-value-rate-title'>How important is this question to you?</h2>
										</div>
