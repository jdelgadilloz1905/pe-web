...
export default function StepTen() {
	...
	return (
		<>
			<MetaDescription title={'Personal Preferences-2 | PE.com'} name={'description'} content={'Personal Preferences-2 | PE.com...'} />
						...
						<ScrollAnimation style={{ height: '100%' }} animateIn='animate__slideInRight' delay={300} duration={2} animateOnce={true}>
							<div className='cw-wizard-ststen-form-global-container'>
								<div className='cw-wizard-ststen-form-main-title-container'>
									<MainTitle
										indicators={[{ indicator: true }, { indicator: true }, { indicator: false }, { indicator: false }]}
								...
								<div className='cw-wizard-ststen-form-container'>
									<ScrollAnimation animateIn='animate__fadeInUp' delay={3000} animateOnce={true}>
										<div className='cw-wizard-ststen-form-title-container'>
											<h2 className='cw-wizard-ststen-form-title'>What level of investment knowledge do you prefer in a client?</h2>
										</div>
										<div className='cw-wizard-ststen-form-option-container'>
											<Checkbox.Group onChange={handleChangeCheckbox} defaultValue={isSelected} value={isSelected}>
												<Row>
													...
													<Col span={24}>
														<Checkbox value='Moderate'>Somewhat knowledgeable: I prefer a client who needs guidence and education with their decisions.</Checkbox>
													</Col>
													<Col span={24}>
														<Checkbox value='High'>
															Seasoned investor: I prefer a client who is up to date and educated with the market and feels confident in their investment decisions.
														</Checkbox>
													</Col>
												</Row>
											</Checkbox.Group>
								...
								<div className='cw-wizard-ststen-value-container'>
									<ScrollAnimation animateIn='animate__fadeInUp' delay={3500} animateOnce={true}>
										<div className='cw-wizard-ststen-value-title-container'>
											<h2 className='cw-wizard-ststen-value-rate-title'>How important is this question to you?</h2>
										</div>
								...
								<ScrollAnimation animateIn='animate__fadeInUp' delay={4000} animateOnce={true}>
									<div className='cw-wizard-ststen-form-buttons-container'>
										<Buttons previous={'/client/step-nine'} next={'/client/step-eleven'} />
									</div>
								</ScrollAnimation>
							</div>
						</ScrollAnimation>
